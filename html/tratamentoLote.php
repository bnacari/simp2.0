            ...
            <table class="tbl-tratamento">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th class="th-sort" onclick="ordenarPor('ponto')">Ponto <ion-icon name="swap-vertical-outline"
                                class="sort-icon"></ion-icon></th>
                        <th class="th-sort" onclick="ordenarPor('data')">Data/Hora <ion-icon
                                name="swap-vertical-outline" class="sort-icon"></ion-icon></th>
                        <th class="th-sort" onclick="ordenarPor('tipo')">Tipo <ion-icon name="swap-vertical-outline"
                                class="sort-icon"></ion-icon></th>
                        <th>Classe</th>
                        <th class="th-sort" onclick="ordenarPor('severidade')">Severidade <ion-icon
                                name="swap-vertical-outline" class="sort-icon"></ion-icon></th>
                        <th>Valor Real / Sugerido</th>
                        <th class="th-sort" onclick="ordenarPor('confianca')">Confianca <ion-icon
                                name="swap-vertical-outline" class="sort-icon"></ion-icon></th>
                        <th class="th-sort" onclick="ordenarPor('status')">Status <ion-icon name="swap-vertical-outline"
                                class="sort-icon"></ion-icon></th>
                        <?php if ($podeEditar): ?>
            ...
            if (podeEditar) {
                ...
                <td>
                    <div class="acoes-rapidas"${desabilitado}>
                        ...
                        <button class="btn-acao validacao" onclick="irParaValidacao(${p.CD_PONTO_MEDICAO}, '${(p.DT_REFERENCIA || '').split('T')[0]}')" title="Abrir na tela de Validacao" style="opacity:1;pointer-events:auto;">
